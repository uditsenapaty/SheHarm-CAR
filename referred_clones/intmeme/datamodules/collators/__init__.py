...
from .mime import image_collate_fn as mime_collator
...
def get_collator(
    ...
    **kwargs
    ...
    if "roberta" in tokenizer_class_or_path:
        processor = FlavaProcessor.from_pretrained("facebook/flava-full")
        tokenizer = AutoTokenizer.from_pretrained(tokenizer_class_or_path)
        return partial(mime_collator, processor=processor, tokenizer=tokenizer, labels=labels)
    elif "flava" in tokenizer_class_or_path:
